...
public class PlayRTCVideoViewGroup extends RelativeLayout {
    ...
    public void createVideoView() {
        ...
        int width = this.getWidth(); //(4.0f * height) / 3.0f;
    ...
    private void createLocalVideoView (final Point screenDimensions) {
        ...
        if(localView == null) {
            ...
            displaySize.y = (int)(screenDimensions.y*0.4);
			 ...
			 * v2.2.5 추가
			 */
            localView.setBgClearColor(222, 222, 222, 255);
            localView.hide(0);
    ...
    private void createRemoteVideoView (final Point screenDimensions) {
        ...
        if(remoteView == null) {
			 ...
			 * v2.2.5 추가
			 */
            remoteView.setBgClearColor(222, 222, 222, 255);
