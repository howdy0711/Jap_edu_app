...
public class test_jlpt3 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        str[0] = "3. だいひょう";
        str[1] = "3. つづいて";
        str[2] = "2. 今ごろ東京では桜(さくら)が咲(さ)いているでしょう。";
        str[3] = "4. ぐらいなら";
        str[4] = "1. 面接 ";
        str[5] = "2. 助けて";
        str[6] = "2. ぐっすり";
        ...
        setContentView(R.layout.test_jlpt3);
        ...
        reslult.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                score =score_integer+"";
                Intent intent = new Intent(getApplicationContext(),test_jlpt3_result.class);
