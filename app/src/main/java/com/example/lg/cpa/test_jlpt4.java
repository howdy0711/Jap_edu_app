...
public class test_jlpt4 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_jlpt4);
        ...
        reslult.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                score = score_integer+"";
                Intent intent = new Intent(getApplicationContext(),test_jlpt4_result.class);
