...
public class test_jlpt1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        str[6] = "1. ところで";
        str[7] = "3. いいようなものの";
        str[8] = "4. 彼のキャリアはそれほど長くないが、この仕事をよく理解している。";
        str[9] = "1. 弱い立場の人をいたわるのは大切なことです。";

        setContentView(R.layout.test_jlpt1);
        ...
        reslult.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                score =score_integer+"";
                Intent intent = new Intent(getApplicationContext(),test_jlpt1_result.class);
